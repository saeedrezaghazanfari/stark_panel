...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('wallet_addr', models.CharField(default='no data', max_length=60, verbose_name='آدرس کیف پول')),
                ('img_qrcode', models.ImageField(blank=True, null=True, upload_to=Stark_siteSetting.models.upload_qrcode_image_path, verbose_name='تصویر کد کیوآر')),
                ('is_active', models.BooleanField(default=False, verbose_name='آیا این تنظیمات در پنل نشان داده شود؟')),
            ],
            options={
                'verbose_name': 'تنظیمات استارک',
                'verbose_name_plural': 'تنظیمات استارک',
                'ordering': ['id'],
            },
        ),
    ]
